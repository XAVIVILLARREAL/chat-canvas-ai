...
- **`docs/ADRs/`** = decisiones de arquitectura registradas (ADR-001: Hono, ADR-002: stack AI-first, ADR-003: frontend React). Si tomas una decisión de arquitectura, crea un ADR.
