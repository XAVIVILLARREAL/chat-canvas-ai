...
- - **Próxima acción**: **Etapa 1 A.3** — trait `AgentProvider` + BYOK (DeepSeekDirect HTTP+SSE, OllamaProvider; router simple/tool-calls) ([plan-a-chat-codex](docs/SDDs/SDD-001-plan-base/plan-a-chat-codex.md))
- **Progreso Etapa 0**: ✅ COMPLETA (GATE 0) · **Etapa 1**: A.0 ✅ · A.1 ✅ · A.2 ✅ (31/31 rust, settings cifradas T.SEC) → A.3 en curso
