...
> **Última actualización:** 2026-08-12 · Etapa 8.6 (canva LOD) ✅ + Etapa 8.5 (warp-mode) 8.5.1–2 ✅ · rama `main`.
...
| **Etapa 8.5 — Warp-mode (SDD-122)** | **✅ 8.5.1–2 2026-08-12**: `packages/warp_core` (tracker + historial JSON por host + fuzzy), terminal con Ctrl+R overlay + sugerencia inline + Tab. 19 unit + 5 widget. Pendiente: 8.5.3 snippets+sync y gate manual | — |
