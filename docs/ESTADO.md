...
- **SIGUIENTE EN ORDEN: slice 0.5** — Frontera del sandbox Linux (contrato de contenedor: CPU 1 · RAM 512MB · disco 1GB · pids 128 · timeout 60s · red off · mounts read-only · non-root · seccomp vía docker API en el worker).
