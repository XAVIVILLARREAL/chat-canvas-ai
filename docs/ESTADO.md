...
- **SIGUIENTE: slice 0.8 GATE 0** — cierre de Etapa 0: todas las verificaciones del schema maestro + eventos + secretos + persistencia real + sandbox provable + OpenAPI + i18n, `check:all` verde, evidencia.
