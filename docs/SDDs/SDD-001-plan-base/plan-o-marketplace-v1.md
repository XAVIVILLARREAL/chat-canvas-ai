...
> [← Maestro](./README.md) · [← PLAN N](./plan-n-empresas-autonomas.md)
...
- Cualquier agente externo (Claude Code, Cursor, Reasonix de otro proyecto) conecta y gana el mismo cerebro — Empresa Dev como infraestructura, no solo app
