...
- **Ceremonia de NACIMIENTO**: al guardar, overlay festivo "Nace [nombre] — bienvenido al equipo" presentando al nuevo miembro con su avatar animado (reutiliza CelebrationOverlay de [U·U.3](./plan-u-motivacion.md#u3)) — la contratación se SIENTE · la VOZ TTS ([K·K.1](./plan-k-voz.md#k1)) se completa al llegar la Etapa 11 — el resto de la identidad (avatar/emoji/bio/ceremonia) NO depende de K
