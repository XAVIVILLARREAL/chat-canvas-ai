          ...
          <div className="glass-deep modal-agente" role="dialog" aria-modal="true" aria-label={t("sidebar.newAgent")} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); guardarAgente(); }}>
              <input
                ...
                aria-label="Nombre"
              />
              <select value={String(rolAgente)} onChange={(e) => setRolAgente(e.target.value as AgentRole)} aria-label="Rol">
              ...
              <div className="modal-actions">
                <button type="button" onClick={() => setModalAgente(false)}>Cancelar</button>
